                    ...
                    <main class="content">
                        ...
                        <article
                            ...
                            <div class='entry-content'>
                                {!! Form::open(['url'=>URL::to('checkout/complete2'),'id'=>'myForm','files'=>true]) !!}
                                ...
                                <div class="row col-md-10" style="margin: auto;padding: 0px;">
                                    ...
                                    <input type="hidden" name="user_loggedin" value="1">
                                        ...
                                        <table class="table checkout-table " style="border-style: hidden;">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text"
                                                           ...
                                                           value="{{$client->email}}"><span id="userresult"
                                            ...
                                            <tr id="make_password">
                                                ...
                                                <td><input type="password"
                                                           style="height: 35px;width: 200px;background-color: #f1f1f1"
                                                           name="password" class="form-control" value="{{$client->password}}"></td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text"
                                                                           ...
                                                                           id="address" required=""
                                                                           value="{{$address->invoice_address}}"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Postal number:</td>
                                                                <td><input type="text"
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text"
                                                                           ...
                                                                           id="s_address"  value="{{$address->shipping_address}}" required=""></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Postal number:</td>
                                                                <td><input type="text"
                                                                           ...
                                                                           id="s_post" value="{{$address->shipping_post_code}}" required=""></td>
                                                            </tr>
                                                            <tr>
                                                                <td>City:</td>
                                                                <td><input type="text"
                                                                           ...
                                                                           id=s_city value="{{$address->shopping_city}}" required=""></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Country:</td>
                                                                <td>

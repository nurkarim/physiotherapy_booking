...
@section('content')
    ...
    <div class="appointments_css">
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-8">
                                {!! Form::model($app,['url'=>['appointments',$app->id],'id'=>'myForm','method'=>'GET','files'=>true]) !!}
                                <div class="form-group" style="margin-top: -10px;">
                                    <table class="table row">
                                        <tr>
                                            <td class="fixedwith-field">
                                                {{ Form::select('client_id',$user, $app->user_id,['class'=>'form-control chosen-select','required']) }}
                                            ...
                                            <td style="" class="fixedwith-field2">
                                                <a href="#" onclick="loadModalLG('clients/create')" data-toggle="modal"
                                                   data-target="#myModal" class="btn btn-sm col-xs-12"
                                ...
                                <div class="form-group row put_right_01 col-lg-6 col-md-6" style="margin-top: -10px;">
                                    <select class="form-control appointment_type"
                                            style="height: 30px;background-color: #f1f1f1;width: 80%;margin-left: 5px;"
                                        ...
                                        @foreach($appointment_type as  $appointment_typeValue)
                                            <option value="{{$appointment_typeValue->id}}"
                                                    @if($app->appointment_type_id==$appointment_typeValue->id) selected="" @endif>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <ul style="" class="hoursbox">
                                                <li class='select_available_hour' style="">Select Available hour</li>
                                                <li class="putinhere"></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="checkbox checkbox-primary">
                                            <input id="checkbox2" type="checkbox" @if($app->recurring==1) checked=""
                                                   @endif name="recurring" value="1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio radio-primary radio-inline">
                                            <input type="radio" name="interval" id="checkbox11" value="4"
                                                   ...
                                                   @if($app->interval==4) checked="" @endif>
                                    ...
                                    <div class="remove_padding">
                                        <div class="form-group">
                                            ...
                                            <div class=" checkbox-warning checkbox-inline">
                                                <input type="text" name="week_note" id="radio6"
                                                       value="{{$app->week_note}}" style="width: 30px;">
                                                <label for="radio6">
                                                    <span class="week_span">daily</span> for
                                                </label>
                                            </div>
                                            <div class=" checkbox-warning checkbox-inline">
                                                <input type="text" name="week_time" id="radio7"
                                                       value="{{$app->week_time}}" style="width: 30px;">
                                                <label for="radio7">
                                                    times
                                                </label>
                                            </div>
                                    ...
                                    <button type="submit" class="btn  btn-sm"
                                            ...
                                            id="make_appointment">Edit Appointment
                                    </button>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
            ...
            <input type="hidden" name="date_value" id="date_value" value="{{$app->date}}">
            <input type="hidden" name="start_times" id="start_times" value="{{$app->start_time}}" required="">
            <input type="hidden" name="start_time_id" id="start_time_id_old" value="{{$app->start_time_id}}"
                   required="">
            <input type="hidden" name="type_price" id="type_price" value="{{$app->price}}">
            <input type="hidden" name="type_name" id="type_name" value="{{$app->appointment_type}}">
            <input type="hidden" name="vat_number" id="vat_number" value="{{$app->vat_number}}">
            <input type="hidden" name="color" id="color" value="{{$app->color}}">
            <input type="hidden" name="specialist_id" id="specialist_id" value="{{$app->specialist_id}}">
            {!! Form::close() !!}
        </div>
    </div>

...
<div class="row">
<div class="col-md-12">
	<h4 style="font-weight: 400;">Invoice List</h4>
...
$arry=array();
			...
			<tr>
				...
				<td><a href="{{url('invoices')}}/{{$dataValue->invoiceId}}/details">#{{$dataValue->invoiceId}}</a></td>
...
<span>UnPaid</span>
				...
				<a class="btn btn-xs btn-danger" target="_blank" href="{{url('invoices')}}/{{$dataValue->invoiceId}}/pdf"><i class="fa fa-file-pdf-o"></i></a>
				</td>
			</tr>
			@endforeach
		</tbody>

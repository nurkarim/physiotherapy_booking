...
<div class="row">
    <form action="{{url('orders/OrderupdateMoreApp')}}" method="post" accept-charset="utf-8">
    {{csrf_field()}}
 <div class="col-md-12">
...
<address class="col-md-6 row" style="">
    ...
    <ul class="col-md-6" style="border-left: 1px solid #000">
        ...
        <p><a href="{{url('invoices/pdf')}}/{{$order->id}}/download" title="" target="_blank">Download pdf</a> | <a href="javascript:void()" onclick="return sendPDF('{{$order->id}}')" title="">Send pdf to client</a> <span id="sms"></span></p>
    </ul>
</div>
                ...
                <table class="table" style="border-style: hidden;">
                    <tr>
                        ...
                        <td style="border-style: hidden;" align="left">
                            <input type="text" name="shippment_cost" placeholder="0.00" style="border:1px solid #000" id="shippment_cost" autocomplete="off" value="{{$order->shippment_cost}}"> <span>€</span></td>
                    </tr>
                    <tr>
                        <td style="border-style: hidden;">Btw</td>
                        <td style="border-style: hidden;width: 2%">:</td>
                        <td style="border-style: hidden;" align="left"><span id="vatShow">{{$order->vat_amount}}</span> <span>€</span>
                            <input type="hidden" class="vatsum" name="vat_price" id="vat_price_g" value="{{$order->vat_amount}}">
                            <input type="hidden" name="vat_number_order" id="vat_price_g" value="{{$order->vat_amount}}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="border-style: hidden;" align="left"><span id="sb_total">{{$order->sub_total}}</span> <span>€</span>
                            <input type="hidden" class="" name="sub_total" id="sub_total" value="{{$order->sub_total}}">
                            <input type="hidden" class="amta" name="sub_total_grand" id="sub_total_grand" value="{{$order->sub_total}}">
                        </td>
                    </tr>
                    <tr>
...
<input type="hidden" class="amt" value="">

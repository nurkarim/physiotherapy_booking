...
<div class="col-md-12">
	<ul class="col-md-5 "><h4 style="letter-spacing: 1px;font-weight: 400;font-size: 24px;">Credit note <a href="" style="color: #52d862;">#{{$invoice->id}}</a> Details</h4></ul>
</div>
...
<address class="col-md-12 row" style="">

	<p><a href="{{url('credit/pdf')}}/{{$order->appoitment_id}}/download" title="" target="_blank">Download pdf</a> | <a href="javascript:void()" onclick="return sendPDF('{{$order->id}}')" title="">Send pdf to client</a> <span id="sms"></span></p>
</address>
...
<table class="table" style="border-style: hidden;">
	<tr>
		...
		<td style="border-style: hidden;" align="left"><input type="text" name="shippment_cost" placeholder="0.00" style="border:1px solid #000;width: 30px;border-style: hidden;" id="shippment_cost" onchange="withShipmentCost()" autocomplete="off" value="{{$order->shippment_cost}}"> <span>€</span></td>
	</tr>
	<tr>

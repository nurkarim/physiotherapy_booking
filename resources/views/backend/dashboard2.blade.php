...
#checkboxType{background-color: #f3f3f3;}
.btn span.glyphicon {
    opacity: 0;
}
...
.text-green {
  color: #69f368;font-size: 22px;
}
.text-dark {
  color: #000000 !important;
}
#inputes{height: 30px;  background-color: #f3f3f3;}
#make_table tr{height: 35px;}
#make_table tr td{font-weight: 400;font-size: 16px;color: #000}
.or{font-size: 30px;text-align: center;}
       </style>
...
<div class="row">
            ...
            <h1 class="page-header" style="font-weight: 400;font-size: 23px;">Appoinments</h1>
                <span class="title-types" style="font-size: 15px;font-weight: bold;color: #000;letter-spacing: 1px;"></span> <span class="title-days" style="font-size: 15px;font-weight: bold;color: #000;letter-spacing: 1px;"></span><span class="title-calenders" style="font-size: 15px;font-weight: bold;color: #000;letter-spacing: 1px;"></span>
                <span class="title-currents" style="font-size: 15px;font-weight: 400;padding-left: 10px;color: #000">Current month</span>
                <span class="" style="font-size: 15px;font-weight: 400;padding-left: 10px;color: #000"> {{count($monthBooking)}} appointments</span>
                </div>
                <!-- /.col-lg-12 -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header" style="border-style: hidden;">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style=""><i class="fa fa-close" style="font-size: 26px"></i></button>
...
var endtime=d2.getHours() + ":00"
           ...
           $('.button').on('click', function () {
                ...
                cache    : false,
                dataType : 'json',
                data     : {'start_time': start_time,'end_time':end_time,'app_date':app_date,'name_in':name_in,'location':location},
    ...
    CalendarApp.prototype.init = function() {
        ...
        var form = '';
        var today = new Date($.now());
   var defaultEvents =<?php if(isset($calender)){ echo $calender; }else {
          echo '';
        } ?>;
 ...
 $('.editPersonalApp').on('click', function () {
   ...
   $.ajaxSetup({
             ...
             var start_timee = $("input[name='start_time1']").val();
                ...
                cache    : false,
                dataType : 'json',
                data     : {'start_time': start_time,'end_time':end_time,'app_date':app_date,'name_in':name_in,'location':location,'edit_id':edit_id},

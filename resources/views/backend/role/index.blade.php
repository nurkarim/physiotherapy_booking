...
<div class="row">
<div class="col-md-12">
	<h4 style="font-weight: 400;">Roles Overview</h4>
</div>
<div class="col-md-12">
	<a class="btn btn-sm" style="color: white;padding-left: 10px;background-color: #52d862" href="{{url('roles/create')}}"><i class="fa fa-plus" style="padding: 2px"></i> <i class="" style="padding: 7px;background-color: white;color:black">Add New </i></a>
</div>
<div class="col-md-12">
	<table class="table " style="margin-top: 10px;width: 60%">
		...
		<tbody>
			<?php $i=1; ?>
@foreach($roles as $dataTypeValue)
			<tr id="image_{{$dataTypeValue->id}}">

				<td>{{$i++}}</td>
				<td>{{$dataTypeValue->role_name}}</td>
				<td>
				<a class="btn btn-xs " href="{{url('roles')}}/{{$dataTypeValue->id}}/edit"><i class="fa fa-pencil"></i></a>

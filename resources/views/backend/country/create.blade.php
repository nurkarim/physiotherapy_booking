...
<div class="row">
    ...
    {!! Form::open(['url'=>URL::to('country'),'id'=>'myForm','files'=>true]) !!}
  <div class="form-group">
  <table class="table" id="tablenew">
  	<tr>
  		<td style="width: 20%">Country Name</td>
  		<td>:</td>
  		<td><input type="text" name="name" class="form-control" required="" placeholder="enter country name"></td>
  	</tr>
	  	<tr>
  		<td style="width: 20%">code</td>
  		<td>:</td>
  		<td><input type="text" name="code" class="form-control" required="" placeholder="enter country code"></td>
  	</tr>
  </table>
  </div>

...
<div class="alert alert-success info-sucInvoice" style="display:none;">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
...
<div class="alert alert-warning sms-nochange" style="display:none;">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Oops!</strong> No Change Occour.<label></label></span><br><br>
</div>
<div class="alert alert-warning db-error" style="display:none;">
	<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
	<strong>Oops!</strong> &nbsp;<label id="textSms"></label></span><br><br>
</div>
...
<div class="alert alert-danger alert-dismissable info-update-dynamic" style="display:none;">
	<strong>oops!</strong> &nbsp;<label></label><br><br>
</div>